...
GitHub installs read the published branch, not your local checkout. If you rename a skill locally, push that branch before using the new GitHub tree URL. This repo keeps `task-deep-dive-implementation` as a compatibility alias for the renamed `investigate-and-implement` skill so older install links keep working.
...
npx skills add llj0824/leoj-agent-skills --skill eval-agent-skills
...
npx skills add https://github.com/llj0824/leoj-agent-skills/tree/main/skills/eval-agent-skills
...
| `eval-agent-skills` | Design and run lightweight evals for Codex skills using prompt sets, deterministic trace checks, and rubric-based grading. |
